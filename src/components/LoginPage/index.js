    ...
    return (
      <div className="login-container">
        <div className="login-form-container">
          <img
            src="https://res-console.cloudinary.com/dnncpaqsn/media_explorer_thumbnails/36aff26411bd1da1e16a321f9857f770/detailed"
            alt="tasty-img"
            className="tasty-img-mobile"
          />
        ...
        <div>
          <img
            src="https://res-console.cloudinary.com/dnncpaqsn/media_explorer_thumbnails/83d4e943a0f7daed229678632ae6ffc3/detailed"
            alt="tasty-img"
            className="tasty-img"
          />
        </div>
